...
## --
## Created : <2014-07-17>
## Updated: Time-stamp: <2014-07-23 08:31:09>
##-------------------------------------------------------------------
PORT_GATEWAY=18100
...
function integration_test () {
    ...
    # request_url_get http://$SERVER_IP:$PORT_GATEWAY/metric?name=adsync_service_status
    # request_url_get http://$SERVER_IP:$PORT_GATEWAY/metric?name=appserver_service_status
    # request_url_get http://$SERVER_IP:$PORT_GATEWAY/metric?name=rmi_service_status
    # request_url_get http://$SERVER_IP:$PORT_GATEWAY/metric?name=rest_service_status
    # request_url_get http://$SERVER_IP:$PORT_GATEWAY/metric?name=tomcat_service_status
