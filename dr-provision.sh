...
knife ec2 server create -r 'recipe[]' -E live -f t2.micro -x ubuntu -I ami-d594c2bc --availability-zone us-east-1c -G "QACouchbaseServer" -S CloudpassServers  -N FI-QA-COUCHBASE-1B --ebs-size 8
