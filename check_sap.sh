...
# 
#  command[check_sap_ms]=/usr/lib64/nagios/plugins/check_sap ms $HOSTADDRESS$ $ARG1$ $ARG2$ 
#  command[check_sap_as]=/usr/lib64/nagios/plugins/check_sap as $HOSTADDRESS$ $ARG1$ 
#  command[check_sap_ex]=/usr/lib64/nagios/plugins/check_sap as $ARG1$ $ARG2$ 
