# $Id: prod/ethsm/jhsm/src/examples/sendrecv.sh 1.1.1.1 2011/04/28 13:38:19EDT Sorokine, Joseph (jsorokine) Exp  $
...
#
# $Source: prod/ethsm/jhsm/src/examples/sendrecv.sh $
# $Revision: 1.1.1.1 $
