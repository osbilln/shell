...
/bin/cp /usr/local/jboss-4.2.3.GA/server/default/log/server.log /usr/local/jboss-4.2.3.GA/server/default/log/server.log."`date --date='0 days ago' +"%Y-%m-%d_%H:%M"`"
/bin/rm -fr /tmp/*
/bin/rm -fr /usr/local/jboss-4.2.3.GA/server/default/work
/bin/rm -fr /usr/local/jboss-4.2.3.GA/server/default/tmp
/bin/rm -fr /usr/local/jboss-4.2.3.GA/server/default/data
