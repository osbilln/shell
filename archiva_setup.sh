...
### make sure you have JAVA_HOME exported
###


export ARCHIVA_RELEASE="1.4-M3"
...
[ ! -e "apache-archiva-${ARCHIVA_RELEASE}" ] && tar -zxf apache-archiva-${ARCHIVA_RELEASE}-js-bin.tar.gz

export ARCHIVA="apache-archiva-${ARCHIVA_RELEASE}"
