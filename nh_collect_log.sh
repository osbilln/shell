...
#################################################################################
# Example: ./nh_collect_log.sh

backup_dir=${1:-"/data/log_backup"}
log_file=${2:-"/var/log/nh_collect_log.log"}
