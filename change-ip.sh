...
echo ""
echo "Step 1 : select option 1 to change your IP address to static and 3 for reboot"
echo "Step 2 : select option 2 to register your VM "
echo ""
echo "----------------------------------------------------------------"
echo ""
sel=0
  ...
  case "$sel" in
      ...
      "2")
        getcompanyinfo
          ...
          chef-client -j /data/virtualappliance/companyStatus.json
      ;;
      "3")
        restart 
      ;;
